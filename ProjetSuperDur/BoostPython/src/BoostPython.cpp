...
void python_run() {
  try {
    ...
    Py_SetPythonHome(
        L"C:\\Users\\paulM\\AppData\\Local\\Programs\\Python\\Python311");
    Py_Initialize();
    ...
    if (global.contains("Calculatrice")) {
      object py_class = global["Calculatrice"];
      object instance = py_class(10);

      object res =
          instance.attr("ajoute")(32); // équivaut à instance.ajoute(32)
